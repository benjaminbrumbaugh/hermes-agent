...
CODING_AGENT_GUIDANCE = (
    ...
    "\n"
    "Respect the user's repo: don't commit, push, or rewrite history without "
    "authorization. Standing authorization in the user's current instructions, "
    "profile, or project rules satisfies this requirement; do not require a "
    "task-specific approval phrase. A current task-specific prohibition still "
    "wins. Never read, print, or commit secrets — leave `.env` and "
