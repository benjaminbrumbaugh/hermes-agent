...
export const ar = defineLocale({
  ...
  settings: {
    ...
    hudModifier: {
      ...
      unavailable:
        'هذه الإيماءة غير متاحة هنا. يتطلب Linux جلسة X11؛ لا يتيح Wayland رصد ضغطات مفاتيح التعديل على مستوى النظام. يظل اختصار HUD الحالي يعمل داخل Hermes.'
    },
    screenshot: {
  ...
  sidebar: {
    ...
    row: {
      ...
      activityUnknown: 'النشاط غير معروف',
      delegatedCalls: (calls, max) => `${calls}/${max} استدعاءات`,
      delegatedElapsed: elapsed => `المدة ${elapsed}`,
      delegatedSubagents: count => `${count} وكلاء فرعيون`,
