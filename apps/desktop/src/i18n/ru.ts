...
export const ru = defineLocale({
  ...
  settings: {
    ...
    config: {
      ...
      minimizeToTrayDesc:
        'Скрывает свёрнутые окна в системном трее (строке меню macOS), пока Hermes продолжает работать. Закрытие, Alt+F4 и Cmd+Q работают как обычно. По умолчанию выключено; действует только на этом устройстве.',
    ...
    hudModifier: {
      ...
      statusTitle: 'Состояние жеста HUD',
      ready:
        'Готово. Отпустите обе клавиши в течение полусекунды, не нажимая другие клавиши и не используя мышь. Остальные сочетания не меняются.',
      permission:
      ...
      unavailable:
        'Жест здесь недоступен. В Linux требуется сеанс X11: Wayland не предоставляет глобальные события нажатия модификаторов. Существующее сочетание HUD по-прежнему работает внутри Hermes.'
    },
    screenshot: {
  ...
  sidebar: {
    ...
    row: {
      ...
      activityUnknown: 'Активность неизвестна',
      delegatedCalls: (calls, max) => `${calls}/${max} вызовов`,
      delegatedElapsed: elapsed => `Прошло ${elapsed}`,
      delegatedSubagents: count => `${count} субагентов`,
