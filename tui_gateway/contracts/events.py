...
class MessageStartPayload(Payload):
    """Empty for renderer turns; external desktop turns carry their ``external_submission_id``."""

    external_submission_id: str | None = None


event("message.start", MessageStartPayload,
      doc="A turn began streaming; payload only identifies an external submission.")
